...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp#p
  400efd:	53                   	push   %rbx#x
  400efe:	48 83 ec 28          	sub    $0x28,%rsp # int a,b,c,d,e,f still 40 -24 = 16b
  400f02:	48 89 e6             	mov    %rsp,%rsi  #arg2
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  #a==1?
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>

  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax  #label2  return = *(x-4) 
  400f1a:	01 c0                	add    %eax,%eax #return=return * 2
  400f1c:	39 03                	cmp    %eax,(%rbx) # *x == return
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>

  400f25:	48 83 c3 04          	add    $0x4,%rbx  #label3 x = x+4
  400f29:	48 39 eb             	cmp    %rbp,%rbx #x p
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>

  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx  #label1 x=&b
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp #p = &f
...
000000000040131b <string_length>:
  ...
  401320:	48 89 fa             	mov    %rdi,%rdx  #+8
  401323:	48 83 c2 01          	add    $0x1,%rdx
  401327:	89 d0                	mov    %edx,%eax
  401329:	29 f8                	sub    %edi,%eax
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)  #+17
  40132e:	75 f3                	jne    401323 <string_length+0x8>
  401330:	f3 c3                	repz retq 
  401332:	b8 00 00 00 00       	mov    $0x0,%eax
  401337:	c3                   	retq   

void strings_not_equal(char* str1, char *str2)

0000000000401338 <strings_not_equal>:
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx  
  40133c:	48 89 fb             	mov    %rdi,%rbx  # arg1
  40133f:	48 89 f5             	mov    %rsi,%rbp  # arg2
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d #length1
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx 
  401357:	41 39 c4             	cmp    %eax,%r12d #length2 = string_length(arg2)+1
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx#arg3
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx#arg4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)#arg8 = 0x14(%rsi)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)#arg7
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9#arg6
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8#arg5
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi#arg2
  401485:	b8 00 00 00 00       	mov    $0x0,%eax#return = 0
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax#return == 0x5
